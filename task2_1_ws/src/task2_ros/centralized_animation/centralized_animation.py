...
def plot_agents_data(NN, MAXITERS, SS, YY, ZZ, RR, FF, grad_z, grad_s, b):
    ...
    #add the b's target to the plot
    go_fig.add_trace(go.Scatter3d(
        x=[MAXITERS-1],
        y=[b[0]],
        z=[b[1]],
        mode='markers',
        name=f'Target_{ii}:(x={b[0]}, y={b[1]})',
...
file_name_yaml = 'parameters_task_2_1.yaml'
...
if os.path.exists(yaml_file_path):
    ...
    show_intermediate_targets = yaml_data['show_intermediate_targets']
...
plot_agents_data(NN, MAXITERS, SS, YY, ZZ, RR, FF, grad_z, grad_s, b)

#launch the robots' animation
robots_animation(NN, MAXITERS, ZZ, SS, RR, b, n_z, dt, corr_length=None, corr_width=None, corr_pos=None, local_targets=RR, view=None, show_intermediate_targets=show_intermediate_targets, corr_points=None, show_corr_points=None)
