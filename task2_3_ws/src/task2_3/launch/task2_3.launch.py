...
parameters_folder = 'src/task2_3/parameters'
...
if os.path.exists(yaml_path):
    ...
    #get potential function's parameters
    qstar = yaml_data['qstar'] 
    K = yaml_data['K']
...
def generate_corridor_points(corr_length, corr_width, corr_pos):
    ...
    #save the corridor points only
    corr_points = points.copy()
...
points, corr_points = generate_corridor_points(corr_length, corr_width, corr_pos)
...
def generate_launch_description():
    ...
    rviz_config_dir = get_package_share_directory('task2_3')
